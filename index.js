...
function useSymbolDescription() {
  ...
  // Отримуємо опис символу symbolDescription в змінну symbolDescription за допомогою властивості description.
...
let myObject = {
  ...
  //   //Повертаємо this
  [Symbol.iterator]() {
    this.current = this.category[this.currentIndex];
